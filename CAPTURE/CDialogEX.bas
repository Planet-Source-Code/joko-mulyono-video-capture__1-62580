...
'<:-) :WARNING: Unused Parameters 'ByVal wParam As Long, ByVal lParam As Long'  could be removed.
...
'<:-) :WARNING: Unused Parameters 'ByVal sFilter As String, ByVal iFilter As Integer'  could be removed.
    ...
    If GetOpenFileName(OFName) Then
        ...
        If (Asc(Mid$(sRtnPath, Len(sRtnPath), 1))) = 0 Then
            ...
            ExFilename = sRtnPath
        Else 'NOT (ASC(MID$(SRTNPATH,...
            ExFilename = sRtnPath
        End If
    Else 'GETOPENFILENAME(OFNAME) = FALSE/0
        OpenDialog = False
    End If
